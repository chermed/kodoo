...
func getInfos(options *Options) *tview.Grid {
	...
	addField(options, infoGrid, 0, 0, "URL", options.Config.URL, false)
	addField(options, infoGrid, 1, 0, "Version", options.Config.Version, false)
	addField(options, infoGrid, 2, 0, "", "", false)
	addField(options, infoGrid, 3, 0, "", "", false)
	return infoGrid
}
...
func getQuickActions(options *Options) *tview.Grid {
	...
	addField(options, quickActionsGrid, 0, 0, "?", "Show help", false)
	addField(options, quickActionsGrid, 1, 0, ":q", "Exit the application", false)
	addField(options, quickActionsGrid, 2, 0, ":x", "List the servers", false)
	addField(options, quickActionsGrid, 3, 0, ":o", "List the macros", false)
	addField(options, quickActionsGrid, 4, 0, "@MacroName", "Execute the macro named <MacroName>", false)
	addField(options, quickActionsGrid, 5, 0, "#Object", "Show the fields of the object <Object>", false)
	addField(options, quickActionsGrid, 6, 0, ">Query", "Run a query (e.g: >sale.order id +name state state=draft partner_id.name~azure)", false)
	addField(options, quickActionsGrid, 7, 0, "", "", false)
...
func getGlobalShortcuts(options *Options) *tview.Grid {
	...
	addField(options, globalShortcutsGrid, 0, 0, "Ctrl-K", "Clear the input", false)
	addField(options, globalShortcutsGrid, 1, 0, "Ctrl-N", "Go to the next command", false)
	addField(options, globalShortcutsGrid, 2, 0, "Ctrl-P", "Go to the previous command", false)
	addField(options, globalShortcutsGrid, 3, 0, "Ctrl-F", "Filter records", false)
	addField(options, globalShortcutsGrid, 4, 0, "Ctrl-O", "List macros", false)
	addField(options, globalShortcutsGrid, 5, 0, "Ctrl-R", "Enable or disable auto-refresh", false)
	addField(options, globalShortcutsGrid, 6, 0, "Ctrl-X", "List servers", false)
	addField(options, globalShortcutsGrid, 7, 0, "Ctrl-H", "Show and hide the help", false)
	addField(options, globalShortcutsGrid, 8, 0, "Ctrl-Q", "Exit the application", false)
	addField(options, globalShortcutsGrid, 9, 0, "Key UP/DOWN", "Navigate through command history", false)
...
func getTableShortcuts(options *Options) *tview.Grid {
	...
	addField(options, tableShortcutsGrid, 0, 0, "n", "go to the next page", false)
	addField(options, tableShortcutsGrid, 1, 0, "p", "go to the previous page", false)
	addField(options, tableShortcutsGrid, 2, 0, "l", "go to the last page", false)
	addField(options, tableShortcutsGrid, 3, 0, "f", "go to the first page", false)
	addField(options, tableShortcutsGrid, 4, 0, "r", "refresh the data", false)
	addField(options, tableShortcutsGrid, 5, 0, "Key <ENTER>", "open related records", false)
	addField(options, tableShortcutsGrid, 6, 0, "!FuncName", "execute the remote function <FuncName>", false)
	addField(options, tableShortcutsGrid, 7, 0, "/filter", "filter the records", false)
	addField(options, tableShortcutsGrid, 8, 0, "", "", false)
	addField(options, tableShortcutsGrid, 9, 0, "", "", false)
